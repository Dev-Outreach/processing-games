...
//It's not needed in most sketches. It's only useful when 
//it's absolutely necessary to define the parameters to size() 
//with a variable. 
void settings() {
...
void draw() { 
  ...
  if (activeState == "won"){
    fill(255);
    text("YOU WIN", width-150,height-50);
  }
}
